...
function Main() {
  ...
  const [unreadMessage, setUnreadMessage] = useState(defaultArr)
  ...
  const handleFlaggedFilter = () => {
    ...
    flagOn ? setFilteredInbox(savedList) : !!filteredInb.length && setFilteredInbox(filteredInb)
  }
  ...
  return (
    <div>
      ...
      <div className="main">
        ...
        <Routes>
          <Route exact path="/inbox" element={<Inbox data={filteredInbox} deletedMessage={deletedMessages} setUnreadMessage={setUnreadMessage} getNumberOfUnreadMessages={getNumberOfUnreadMessages} getFlaggedData={getFlaggedData} />} />
          <Route exact path="/spam" element={<Spam />} />
          <Route exact path="/deleted-items" element={<DeletedItems messages={deletedMessage} deletedMessage={deletedMessages} />} />
